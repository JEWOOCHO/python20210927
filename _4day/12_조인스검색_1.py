...
f = open("D:\WORK\python\_4day\\오늘의부동산.txt", "wt", encoding="utf-8")
for n in range(1,3):
        #클리앙의 중고장터 주소  ### change 
        #판교
        ...
        #송강동
        data ='https://price.joinsland.joins.com/theme/index_theme.asp?CSRFToken=hePrEqRNixPnzaKJfjgljlWhRccfQchrRTxxkIAg&sisaegbn=T07&areaCode=3020000000&searchgbn=' + str(n)

        #https://price.joinsland.joins.com/area/index.asp?mcateGroup=A1&areaCode=3020000000
